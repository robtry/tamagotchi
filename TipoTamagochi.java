public enum TipoTamagochi {
  ...
  */
  ...
  PLAYER(new int[] {5, 10}, new int[] {40, 10}, new int[] {5, 10}, new int[] {5, 10}, new int[] {5, 20}, new int[] {15, 30}, new int[] {15, 40}),
  SLEEPY(new int[] {5, 10}, new int[] {40, 15}, new int[] {5, 10}, new int[] {5, 10}, new int[] {5, 10}, new int[] {15, 15}, new int[] {5, 40}),
DELICATE(new int[] {5, 10}, new int[] {40, 10}, new int[] {5, 15}, new int[] {5, 10}, new int[] {5, 10}, new int[] {15, 15}, new int[] {5, 10}),
  LOVELY(new int[] {5, 10}, new int[] {40, 10}, new int[] {5, 10}, new int[] {5, 15}, new int[] {5, 10}, new int[] {10, 15}, new int[] {10, 10});
  private int[][] values;
